let allowDisplayVideos = true; // Flag to control video display
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    homeButton.addEventListener('click', function() {
        allowDisplayVideos = false;
        container.innerHTML = '';
        console.log(allowDisplayVideos);
        return;
    })
});

function displayVideos(videoIDs) {
    if (!allowDisplayVideos) {
        return;
    }
